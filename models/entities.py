...
class Pessoa(Base):
    ...
    medico: Mapped[Medico | None] = relationship(back_populates="pessoa")
    paciente: Mapped[Paciente | None] = relationship(back_populates="pessoa")
    telefones: Mapped[list[Telefone]] = relationship(back_populates="pessoa")
    documentos: Mapped[list[Documento]] = relationship(back_populates="pessoa")
...
class Medico(Base):
    ...
    data_inativacao: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)

    id_pessoa: Mapped[int | None] = mapped_column(ForeignKey("pessoa.id"))
    pessoa: Mapped[Pessoa | None] = relationship(back_populates="medico")
    ...
    procedimentos: Mapped[list[MedicoProcedimento]] = relationship(
        back_populates="medico"
    )
...
class TipoEspecialidade(Base):
    ...
    consultas: Mapped[list[Consulta]] = relationship(
        back_populates="tipo_especialidade"
    )
...
class MedicoEspecialidade(Base):
    ...
    medico: Mapped[Medico] = relationship(back_populates="especialidades")
...
class Consulta(Base):
    ...
    medico: Mapped[Medico | None] = relationship(back_populates="consultas")
    tipo_especialidade: Mapped[TipoEspecialidade] = relationship(
...
class MedicoProcedimento(Base):
    ...
    medico: Mapped[Medico] = relationship(back_populates="procedimentos")
    tipo_procedimento: Mapped[TipoProcedimento] = relationship(
